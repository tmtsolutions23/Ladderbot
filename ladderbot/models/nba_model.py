"""NBA prediction model for LadderBot.

Logistic regression for P(home_win) + optional linear regression for totals.
Supports training, prediction, calibration (Platt scaling), and persistence.
"""
import pickle
...
class NBAModel:
    """NBA game outcome and totals prediction model.
    ...
    def train(
        ...
        Args:
            ...
            totals: Optional total points vector for totals regression.
        """
    ...
    def predict_total(self, features_dict: dict[str, float]) -> float:
        """Predict total points from a feature dictionary.
    ...
    @classmethod
    def load(cls, path: str) -> "NBAModel":
